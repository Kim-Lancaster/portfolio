    ...
    return (<section id="projects">
        <div className="outer">
            ...
            <Project 
                ...
                image={mykeeper} alt="my keeper thumbnail" 
                githubLink="#home"
                liveLink="#home" 
            ...
            <Project 
                ...
                image={tictactoe} alt="Tic tac toe game" 
                githubLink="#home"
                liveLink="#home" 
            ...
            <Project 
                ...
                image={dinner} alt="what's for dinner thumbnail" 
                githubLink="#home"
                liveLink="#home" 
                text="I built this arbitrary piece of software with JQuery.  Nobody told me that JQuery was a dying library... understandable because React is way better.  But, I spent time and tears on it so I'm keeping this " icons={[
                    {
                    icon: "devicon-html5-plain",
                    iconName: "HTML5"
                    },
            ...
            />
            <Project 
                projectTitle="Eleanor's Cupcakes" 
                image={cupcake} alt="cupcake website thumbnail" 
                githubLink="#home"
                liveLink="#home" 
                text="This is my latest project.  It is super awesome because everything I touch is gold.  Honestly, I don't know why you haven't hired me yet.  I'm fighting companies off with a stick I'm so sought after.  Like Helen of Tory for the software engineering world.  Probably going to be a huge war just to have me. The Gods wept when I was born." 
                icons={[
